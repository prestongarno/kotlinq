...
object AnonymousClassroom : QType {
  ...
  val studentNames: Property<List<String>> by QScalar.List.String.stub()
  ...
  val studentNamesArgs: OptionallyConfiguredProperty<List<String>, FooArgs> by QScalar.List.String.optionallyConfigured()
  ...
  val studentWithNamesArgs: ConfiguredProperty<List<String>, FooArgs> by QScalar.List.String.configured()
  ...
  val nullStudentNames: Property<List<String>?> by QScalar.List.String.stub().asNullable()
  ...
  val nullStudentNamesArgs: OptionallyConfiguredProperty<List<String>?, FooArgs> by QScalar.List.String.optionallyConfigured<FooArgs>().asNullable()
  ...
  val nullStudentWithNamesArgs: ConfiguredProperty<List<String>?, FooArgs> by QScalar.List.String.configured<FooArgs>().asNullable()
...
class BasicPrimitiveArray {
  ...
  @Test fun `string array is possible`() {
    ...
    query::names.returnType.jvmErasure eq List::class
    query::names.returnType.arguments.first().type?.classifier eq String::class
