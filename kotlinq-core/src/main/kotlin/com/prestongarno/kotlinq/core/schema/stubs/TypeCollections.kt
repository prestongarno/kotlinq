...
interface TypeListStub<in E : QType> {
  ...
  operator fun <U : Model<E>> invoke(init: () -> U): GraphqlDslBuilder.Context<List<U>>


  interface NoArg<in E : QType> : TypeListStub<E> {
    override fun <U : Model<E>> invoke(init: () -> U): GraphqlDslBuilder.NoArgContext<List<U>>
  }


  interface OptionallyConfigured<in E : QType, A : ArgumentSpec> : TypeListStub<E> {
    override fun <U : Model<E>> invoke(init: () -> U): GraphqlDslBuilder.OptionallyConfiguredContext<List<U>, A>
  }


  interface Configured<in E : QType, A : ArgumentSpec> : TypeListStub<E> {
    override fun <U : Model<E>> invoke(init: () -> U): GraphqlDslBuilder.ConfiguredContext<List<U>, A>
  }
}
...
sealed class TypeListStubImpl<in E : QType>(val typeName: String, propertyName: String) {
  ...
  abstract fun <U : Model<E>> build(init: () -> U): GraphqlDslBuilder.Context<List<U>>
  ...
  class Configured<in E : QType, A : ArgumentSpec>(
    ...
    override fun <U : Model<E>> build(init: () -> U): GraphqlDslBuilder.ConfiguredContext<List<U>, A> =
  ...
  class OptionallyConfigured<in E : QType, A : ArgumentSpec>(
    ...
    override fun <U : Model<E>> build(init: () -> U): GraphqlDslBuilder.OptionallyConfiguredContext<List<U>, A> {
  ...
  class NoArg<in E : QType>(
    ...
    override fun <U : Model<E>> build(init: () -> U): GraphqlDslBuilder.NoArgContext<List<U>> =
...
private
fun <U : Model<E>, E : QType> TypeListStubImpl<E>.adapter(init: () -> U)
