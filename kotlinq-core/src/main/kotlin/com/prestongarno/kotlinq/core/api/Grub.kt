...
interface StubProvider<out X : GraphQlPropertyDelegate<T>, out Y : GraphQlPropertyDelegate<T?>, out T : Any?> {
...
internal
class Grub<out X : GraphQlPropertyDelegate<T>, out Y : GraphQlPropertyDelegate<T?>, out T: Any?>(
    val typeName: String,
