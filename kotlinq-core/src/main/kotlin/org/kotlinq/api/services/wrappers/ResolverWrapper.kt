...
class ResolverWrapper(default: Resolver)
  ...
  override fun resolve(value: Map<String, Any?>, target: Fragment): Boolean = instance().resolve(value, target)
  ...
  override fun visit(target: InstanceAdapter) = instance().visit(target)
